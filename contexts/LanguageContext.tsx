...
const translations = {
  en: {
    ...
    experience: {
      ...
      tfliteChatbot: {
        title: "TFLite Chatbot Development",
        category: "AI/ML Development",
        period: "New Business Project",
        description: "TFLite model-based CLI chatbot prototype and backend API integration",
        achievements: [
      ...
      sdkMigration: {
        title: "SDK Migration Automation",
        category: "Dev Productivity",
        period: "Platform Migration",
        description: "SDK version migration and Python-based automation tooling",
        achievements: [
  ...
  ko: {
    ...
    experience: {
      ...
      tfliteChatbot: {
        title: "TFLite 기반 챗봇 개발",
        category: "AI/ML 개발",
        period: "신사업 프로젝트",
        description: "TFLite 모델 기반 CLI 챗봇 프로토타입 개발 및 백엔드 API 연동",
        achievements: [
      ...
      sdkMigration: {
        title: "SDK Migration 자동화",
        category: "개발 생산성",
        period: "플랫폼 마이그레이션",
        description: "SDK 버전 마이그레이션 및 Python 기반 자동화 도구 개발",
        achievements: [
